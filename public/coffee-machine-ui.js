(() => {
  const data = {
    ...
    installed: [
      ['Café em Grãos NPro 1kg', '1', 'Pacote instalado na máquina', 'Não conta como estoque fechado.'],
    ],
    readings: [
    ...
    divergence: [
      ['16/06/2026', 'Cappuccino Barista', 'Cappuccino Tradicional', 'R$ 144,23', 'R$ 266,43', 'R$ 144,23', 'Ruptura do Barista na indústria', 'Wellington / Nestlé', 'Aguardando alinhamento definitivo com Thiago'],
    ],
  ...
  function addCard() {
    ...
    if (!grid || document.querySelector('[data-coffee-card="1"]')) return;
  ...
  function openModal() {
    ...
    modal.innerHTML = `
      <header class="coffee-head">
        <div><p>HUB SM</p><h2>Máquina de Café</h2><small>Última atualização: 30/06/2026</small></div>
        <button type="button" class="coffee-close">Fechar</button>
      </header>
      <section class="coffee-summary">
        <article><span>Total atual</span><strong>1.822 doses</strong></article>
        <article><span>Última leitura</span><strong>30/06/2026</strong></article>
        <article><span>Último consumo</span><strong>142 bebidas</strong></article>
        <article><span>Média</span><strong>20/dia</strong></article>
      </section>
      <section class="coffee-alerts">
        <strong>Alertas</strong>
        <p>Relógio da máquina incorreto. KitKat sem estoque confirmado. Cappuccino entregue diferente do pedido.</p>
      </section>
