...
export function SimplePublicAuditorioPage() {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const nextReceipt = await submitPublicAuditorioRequest({
        ...
        foodResponsible: hasFood ? "outro" : "",
        foodResponsibleOther: hasFood ? "Não informado" : "",
              ...
              <form className="auditorio-simple-form" onSubmit={submit}>
                <fieldset>
                  ...
                  <label>
                    ...
                    <select value={form.foodType} onChange={(event) => updateForm({ foodType: event.target.value as AuditorioFoodType })} required>
                  ...
                  {hasCurrentConflict && (
                    <p className="auditorio-public-warning">Esse horário conflita com uma reserva já aprovada. Escolha outro horário.</p>
                  )}
                </fieldset>
