...
# Afazeres: FEITO usa a conclusão sincronizada; EXCLUIR continua sendo exclusão simples.
replace_once(
...
replace_once(
    "src/modules/tasks/TaskBoardScreen.tsx",
    "  deleteHubTask,\n",
    "  completeHubTask,\n  deleteHubTask,\n",
)
replace_first(
...
replace_once(
    "src/modules/tasks/TaskBoardScreen.tsx",
    '{inAlerts ? "Tirar dos alertas" : "Alertar"}',
    '{inAlerts ? "Tirar dos alertas" : "Mostrar nos alertas"}',
)

# Chamados: carregar o estado do painel e permitir mostrar/ocultar manualmente.
replace_once(
    "src/modules/service-requests/ServiceRequestsScreen.tsx",
...
# Painel: incluir Chamados e avisos operacionais sem colocá-los no gerenciador de rotinas.
replace_once(
    "src/modules/alerts/AlertDashboardEnhancer.tsx",
